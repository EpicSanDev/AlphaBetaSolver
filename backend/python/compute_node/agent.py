...
async def main():
    ...
    parser.add_argument("--rabbitmq-url", default="amqp://guest:guest@localhost/",
                        help="URL de connexion RabbitMQ")
    parser.add_argument("--queue-name", default="computation_tasks",
                        help="Nom de la queue des tâches")
    parser.add_argument("--result-queue", default="computation_results",
